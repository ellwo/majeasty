        ...
        <section class=" ">
            ...
            <div class="container px-6 py-10 mx-auto">
                <form method="get" class="p-6" action="{{url('product/all/')}}">
                ...
                <div class="lg:flex lg:items-center">
                    <div class="w-full flex-wrap  space-y-12  ">
                        <div dir="rtl" class="block w-full ">
                            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">تصفح <br> منتجاتنا المميزة</h1>
                        ...
                        <div dir="rtl" class=" w-full  flex flex-wrap ">
                        @foreach ($depts as $dept )

                        <div class=" lg:w-1/2 w-full space-y-4 mt-8 ">


                            <span class="flex flex-col  p-2 text-blue-500 dark:bg-dark-eval-1 bg-white rounded-xl md:mx-4 dark:text-white ">


                                <div class="md:flex">
                                <img class="inline-block h-64 rounded-lg " src="{{$dept->img}}"/>
                                <div class="mt-4 md:mx-4 md:mt-0">
                                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                                        {{$dept->name}}</h1>
                                        <div class="">
                                            <span class="inline-block w-40 h-1 rounded-full bg-m_primary"></span>
                                            <span class="inline-block w-3 h-1 ml-1 rounded-full bg-m_primary"></span>
                                            <span class="inline-block w-1 h-1 ml-1 rounded-full bg-m_primary"></span>
                                        </div>
                                    <p class="mt-3 h-64 overflow-y-hidden  text-gray-500 dark:text-gray-300">
                                    {{$dept->note}}
                                    </p>
                            ...
                            <a class="block w-full btn btn-outline" href="{{url("product/".$dept->id)}}"> تصفح الان</a>
                ...
                <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
                    ...
                    <div class="flex flex-col items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                        <img class="h-12 text-gray-500 fill-current dark:text-gray-300" src="{{ $brand->img }}" alt="" srcset="">
                        <span class="font-bold uppercase">{{ $brand->name }}</span>
                    </div>
