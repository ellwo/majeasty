<x-admin-layout>
    ...
    <div class="w-full ">
        ...
        <div class="w-full ">
            ...
            <div class="w-full px-6 py-4 mx-auto my-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
...
{{--
                ...
                <div class="mt-4 space-y-2" dir="auto">
                    ...
                    <textarea class="w-full rounded-md input-primary dark:bg-dark-eval-1" rows="5" id="note" placeholder="{{__('من نحن ')}}" name="note" >{{config("mysetting.note")}}</textarea>
                </div>
