                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div class="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                            ...
                            <div class="ml-4 text-md tracking-wide font-semibold w-40">
                                <a href="callto:{{config('mysetting.phone_no')}}">{{config('mysetting.phone_no')}}</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                            ...
                            <div class="ml-4 text-md tracking-wide font-semibold w-40">
                               <a href="mailto:{{config('mysetting.email_link')}}"> {{config('mysetting.email_link')}}</a>
                            </div>
                        </div>
                    ...
                    <form method="post" action="{{route('contact.form')}}" class="p-6 flex flex-col justify-center">
                        @csrf
