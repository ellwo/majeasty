        ...
        this.inputimg.change(function(e) {
            ...
            for (var i = 0; i < e.target.files.length; i++) {
                ...
                if (mx_h != -1 && mx_w != -1) {
                    ...
                    convert_to_base64_orginal_w(e.target.files[i], lcolor, this, id_d, url, input_id, w, h);
...
function convert_to_base64_orginal_w(e, color, inputimg, id, urll, inputname, w, h) {
